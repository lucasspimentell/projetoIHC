function ingles(){
    ...
    let ingles = `<pre>
        ...
        And find someone who really wants her  

        <span style = "color : red;">G </span> 
        Like you never tried to be  

        <span style = "color : red;">Am7</span>   
        Yeah, I know, she’ll only find  
        ...
        That luck has chosen you  

        <span style = "color : red;">G</span>  
        And you’re blind to even notice  

        <span style = "color : red;">Am7</span>  
        When everything is still nothing  

        When the day is still the night  
        ...
        There’s no path someone else  

        <span style = "color : red;">G</span>  
        Can walk in your place  

        <span style = "color : red;">Am7</span>  
        I wish I could insist  

        But the road only exists  

        <span style = "color : red;">G</span>  
        When you decide to walk it  
        ...
        You want childish and wild  

        <span style = "color : red;">G</span>  
        A sun above the sun  

        <span style = "color : red;">Am7</span>  
        But when always becomes never  

        When what's beside you feels much farther 
        ...
        [Bridge]  
        <span style = "color : red;">Am7</span>  
        Oh, one day she’ll find  

        Someone who truly wants her  
        ...
        Or preachy, or cliché  

        <span style = "color : red;">G </span> 
        This was what was troubling me  
